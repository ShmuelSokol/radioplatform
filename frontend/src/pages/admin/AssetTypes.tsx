...
import { useAssetTypes, useCreateAssetType, useUpdateAssetType, useDeleteAssetType } from '../../hooks/useAssetTypes';
...
export default function AssetTypes() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Asset Types</h1>
      ...
      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
        {assetTypes && assetTypes.length > 0 ? (
                ...
                <tr key={at.id}>
                  ...
                  <td className="px-6 py-3 text-right space-x-3">
                    {editingId === at.id ? (
                      ...
                      <>
                        <button
                          onClick={() => startEdit(at.id, at.name)}
          ...
          <div className="px-6 py-10 text-center text-gray-500">
            No asset types yet. Add one above.
          </div>
        )}
      </div>
    </div>
