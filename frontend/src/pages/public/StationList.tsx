...
export default function StationList() {
  ...
  if (isLoading) return <div className="text-center py-10">Loading stations...</div>;
        ...
        {data?.stations.map((station) => (
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-brand-50 rounded-lg flex items-center justify-center text-3xl text-brand-600 group-hover:bg-brand-100 transition">
                &#9835;
              </div>
              <div>
                <h2 className="text-lg font-semibold group-hover:text-brand-600 transition">
                  {station.name}
                </h2>
